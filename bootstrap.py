...
class LavalinkBootstrap:
    ...
    def __init__(self):
        ...
        self.download_command = f"curl -L https://github.com/Frederikam/Lavalink/releases/download/3.3.1.4/Lavalink.jar?guest=1 -o Lavalink.jar" if self.use_dev_lavalink else f"curl -L https://github.com/Frederikam/Lavalink/releases/download/{self._version_number}/Lavalink.jar -O"
